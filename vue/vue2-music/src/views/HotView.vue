  ...
  <div class="hotMusic">
    ...
    <div class="hot-top">
      <div class="hot-top-wrap">
        <div class="hot-musicbang">热歌榜</div>
...
.hotMusic {
  ...
  .hot-top {
    ...
    &::after {
      ...
      z-index: -1;
      background: url("../assets/img_hot_bk.png") no-repeat;
    ...
    .hot-top-wrap {
      ...
      .hot-musicbang {
        ...
        // background-position: -24rem -45rem;
  ...
  .hot-list {
    background: linear-gradient(180deg, #621445, rgb(18, 19, 23) 30%);
