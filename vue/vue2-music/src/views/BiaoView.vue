  ...
  <div class="hotMusic">
    ...
    <div class="hot-top">
      <div class="hot-top-wrap">
        <div class="hot-musicbang">飙升榜</div>
...
<script>
import BiaoMusic from "@/components/BiaoMusic.vue";
...
.hotMusic {
  ...
  .hot-top {
    ...
    &::after {
      ...
      z-index: -1;
      background: url("../assets/img_up_bk.png") no-repeat;
  ...
  .hot-list {
    background: linear-gradient(180deg, #0e2b33, rgb(18, 19, 23) 30%);
